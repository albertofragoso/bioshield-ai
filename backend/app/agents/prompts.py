"""Prompt constants for BioShield agents.

Mirror of docs/prompts.md — the test_prompts_sync test fails if these diverge.
Changing a prompt here requires updating docs/prompts.md in the same commit.
"""
...
__all__ = ["EXTRACTOR_PROMPT", "RECONCILER_PROMPT", "OCR_CORRECTION_PROMPT"]
