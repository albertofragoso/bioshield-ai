...
Creates user demo@bioshield.app with a password sourced from DEMO_USER_PASSWORD
env var, and pre-loads fictional biomarker data.

Usage (inside the container via make seed):
...
DEMO_PASSWORD = os.environ["DEMO_USER_PASSWORD"]  # required — never hardcode
...
async def main() -> None:
    ...
    print(f"\nDemo user ready: {DEMO_EMAIL}")
    print("  Note: all biomarker values are fictional demo data")
